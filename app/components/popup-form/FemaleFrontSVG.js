...
export default function FemaleFrontSVG({ formData, onPathClick }) {
  ...
  return (
    <div>
      ...
      <div id="ffb-wrapper">
        <div id="ffb-basea" className="bodychart-front">
          <svg
            version="1.1"
          ...
          >
            <image overflow="visible" className="w-full h-full max-h-[400px]" href="/model/f-modela.png" />
            <path
              id="ffb_1"
              className="head"
              fill="transparent"
            ...
            <path
              ...
              stroke="#8C8C8C"
              vectorEffect="non-scaling-stroke"
              d="M383.226,444.009c-10.693-4.799-23.979-13.26-41.064-13.26c-17.085,0-29.153,7.884-41.201,13.146c-41.381,18.075-46.567-10.247-48.83-14.238c1.571,19.306,3.148,48.961,2.115,56.194c-1.135,7.941-9.276,28.039-14.799,41.473c3.636,7.516,25.04,39.648,101.913,39.648c76.873,0,99.986-31.362,104.039-39.648c-2.225-5.323-4.486-11.973-5.403-14.723c-1.25-3.75-6.75-17-9.25-23.25c-1.723-4.308,0.592-39.376,2.524-61.86C430.212,437.224,423.246,461.971,383.226,444.009z"
              onClick={handlePathClick}
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
            />
            <path
              ...
              stroke="#8C8C8C"
              vectorEffect="non-scaling-stroke"
              d="M447.745,532.352c-0.733-1.333-1.538-3.092-2.347-5.027c-4.053,8.286-27.166,39.648-104.039,39.648c-76.873,0-98.277-32.132-101.913-39.648c-1.779,4.327-3.287,7.963-4.201,10.277c-0.718,1.819-4.753,12.178-9.266,28.098c20.901,5.683,66.602,53.919,86.013,79.232c5.745,7.492,9.585,12.977,10.419,14.754c15.333,17.167,28.667,12.5,40.834-0.834c0.847-1.714,4.106-7.152,9.088-14.609c16.61-24.865,56.122-72.163,85.544-78.591C453.102,546.989,448.684,534.059,447.745,532.352z"
              onClick={handlePathClick}
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
            />
            <path
              ...
              stroke="#8C8C8C"
              vectorEffect="non-scaling-stroke"
              d="M243.496,279.133c0.364-24.852,15.205-46.08,48.082-49.281c-4-3-26.667-10-47.333-13.5c-8.017,0.671-36.833-0.833-45.5,44.5c-1.326,6.935-6.612,29.151-8.441,49.643C198.757,297.442,235.279,295.249,243.496,279.133z"
              onClick={handlePathClick}
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
            />
            ...
            <path
              ...
              stroke="#8C8C8C"
              vectorEffect="non-scaling-stroke"
              d="M517.358,401.382c-0.201-0.769-0.409-1.559-0.633-2.391c-2.22-8.277-5.535-19.675-10.48-34.389c-3.74-11.129-6.349-20.294-8.152-27.713c-1.16-4.771-1.988-8.82-2.571-12.207c-0.995-5.78-1.276-9.627-1.276-11.83c-2.494-18.108-47-16-52.073-36.997c0.378,10.705-1.159,21.191-1.593,28.995c-0.355,6.382,1.011,11.205,2.81,16c3.469,9.245,8.547,18.391,6.022,38.418c0.333,1.917,1.834,4.083,2.667,6.916c0.833,2.834,7.334,22.667,10.334,30.833c1.362,3.709,3.618,8.688,5.8,13.723C473.072,423.191,524.631,432.896,517.358,401.382z"
              onClick={handlePathClick}
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
            />
            <path
              ...
              stroke="#8C8C8C"
              vectorEffect="non-scaling-stroke"
              d="M166.926,401.95c-0.381,1.295-0.701,2.449-0.931,3.402c-3.25,13.5-5.75,23.5-9.5,29.75c-1.344,2.239-4.423,8.375-7.957,16.714c8.213-9.979,21.624-12.289,31.76-7.811c10.472,4.626,18.204,17.605,19.489,33.772c0.413-1.687,0.739-3.183,0.957-4.425c1.667-9.5,6.5-29,8-37.667c1.123-6.486,4.299-15.679,6.805-22.06C205.576,422.521,168.898,423.484,166.926,401.95z"
              onClick={handlePathClick}
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
            />
