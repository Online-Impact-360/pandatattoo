...
export default function MaleFrontSVG({ formData, onPathClick }) {
  ...
  return (
    <div>
      ...
      <div id="mfb-wrapper">
        <div id="mfb-basea" className="bodychart-front">
          <svg
            version="1.1"
          ...
          >
            <image overflow="visible" className="w-full h-full max-h-[400px]" href="/model/m-modela.png" />
            <path
              id="mfb_1"
              className="head"
              fill="transparent"
