...
export default function MaleBackSVG({ formData, onPathClick }) {
  const { tipRef, handlePathClick, handleMouseEnter, handleMouseLeave, updateTipPosition } = useBodyChart(formData, onPathClick);

  return (
    <div>
      <div className="w-full block h-[20px] text-center text-black">
        <span id="tip-mfb" ref={tipRef}></span>
      </div>
      <div id="mfb-wrapper">
        <div id="mfb-baseb" className="bodychart-back">
          <svg
            version="1.1"
          ...
          >
            <image overflow="visible" className="w-full h-full max-h-[400px]" href="/model/m-modelb.png" />
            <path
              id="mfb_28"
              className="head-back"
              fill="transparent"
